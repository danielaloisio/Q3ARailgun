...
#if defined( QGL_LINKED ) || ( !defined( _WIN32 ) && !defined(MACOS_X) && !defined( __linux__ ) && !defined( __FreeBSD__ ) )
...
#if ( (defined __linux__ )  || (defined __FreeBSD__ ) ) && !defined(__APPLE__) // rb010123
